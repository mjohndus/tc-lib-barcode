...
<svg'
	...
	<desc>01001100011100001111,10110011100011110000</desc>
        <rect x="0" y="0" rx="0" ry="0" width="44.000000" height="8.000000" fill="#ffff00" />
...
';
    ...
    public function testGetSvg(): void
    {
        ...
        $this->assertEquals('89837941e6ccb0c421c842068a52702e', \md5($svg));
        $headers = xdebug_get_headers();
        $this->assertEquals(
            'Content-Disposition: inline; filename="89837941e6ccb0c421c842068a52702e.svg";',
            $headers[5]
        );
